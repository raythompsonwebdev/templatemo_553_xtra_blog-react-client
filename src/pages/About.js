            ...
            <div className="mb-4">
                ...
                <p>
                    You can immediately download 
                        <Link rel="nofollow" to="https://templatemo.com/tm-553-xtra-blog" target="_blank">Xtra Blog Template</Link> 
    ...
    <div className="row tm-row tm-mb-60">
        ...
        <div className="col-lg-6 tm-mb-60 tm-person-col">
            <div className="media tm-person">
                ...
                <div className="media-body">
                    <h2 className="tm-color-primary tm-post-title mb-2">John Henry</h2>
        ...
        <div className="col-lg-6 tm-mb-60 tm-person-col">
            <div className="media tm-person">
                ...
                <div className="media-body">
                    <h2 className="tm-color-primary tm-post-title mb-2">Catherine Soft</h2>
